...
function _getEditorContent(t) {
    ...
    if (e) {
        ...
        if (n.find("pinit").remove(), n.find(".thunderpin").remove(), n.find(".pin").parent().remove(), n = $(n).html())
            for (;;) {
...
var Notebook = {
    cache: {}
        ...
        cache: {}
    }, Tag = {}, Notebook = {}, Share = {}, Mobile = {}, LeaAce = {}, Converter, MarkdownEditor, ScrollLink, MD;
$.extend(LEA, {
    _eventCallbacks: {},
...
var vd = {
    ...
    init: function(form, rule_funcs) {
        ...
        var rules = {}, msg_targets = {}, $allElems = $(form).find("[data-rules]"),
            $form = $(form);
        $form.on({
            keyup: function(t) {
...
Note.checkSorter = function(t) {
    ...
    if (t) {
        ...
        if (isArray(o)) {
            var a = o.length;
            if (0 == a)
                for (var n in Note.cache) Note.cache[n].NotebookId == t && (Note.cache[n].IsBlog = e);
            else
                for (var n = 0; a > n; ++n) o[n].IsBlog = e
        }
    }
    ...
    function t(t) {
        var e = $(this).attr("noteId"),
            o = [];
        if (Note.inBatch) o.push("shareToFriends"), o.push("exportPDF"), Notebook.curActiveNotebookIsTrash() && (o.push("shareStatus"), o.push("unset2Blog"), o.push("set2Blog"), o.push("copy"));
        else {
...
var Attach = {
    ...
    deleteAttach: function(t) {
        for (var e = this, o = Note.curNoteId, a = e.loadedNoteAttachs[o], n = 0; n < a.length; ++n)
            if (a[n].AttachId == t) {
                a.splice(n, 1);
                break
            }
...
Note.inBatch = !1, Note.getBatchNoteIds = function() {
    ...
    clearByStart: function(t) {
        ...
        if (t) {
            ...
            if (!isEmpty(o))
                for (var a = 0; a < o.length; ++a) e.clearTarget(o[a])
        }
    },
    selectTo: function(t) {
...
function _initPage(e, t) {
    if (e ? (curNoteId = e.NoteId, curNotebookId = e.NotebookId, noteContentJson = e) : t && (curNoteId = null), Notebook.renderNotebooks(notebooks), Share.renderShareNotebooks(sharedUserInfos, shareNotebooks), curSharedNoteNotebookId) Share.firstRenderShareNote(curSharedUserId, curSharedNoteNotebookId, curNoteId);
        ...
        for (var i = 0; i < latestNotes.length; ++i) Note.addNoteCache(latestNotes[i]);
...
LEA.s3 = new Date, console.log("initing..."), $(window).resize(function() {
    ...
    var t = $(this).val(),
        ...
        i = o.split("="),
        n = 1;
    2 == i.length && (n = i[1]), $("#themeLink").attr("href", LEA.sPath + "/css/theme/" + t + ".css?id=" + n), ajaxPost("/user/updateTheme", {
        theme: t
    }, function(e) {
...
Notebook.curNotebookId = "", Notebook.cache = {}, Notebook.notebooks = [], Notebook.notebookNavForListNote = "", Notebook.notebookNavForNewNote = "", Notebook.setCache = function(o) {
    ...
    t.showNoteAndEditorLoading(), t.changeNotebookSeq++,
    function(o) {
